...
const CardMainPost: FC<PostItemProps> = ({post}) => {
    ...
    return (
        ...
        <div className="post-main__card-footer-info-img">
            ...
            <p className="post-main__card-footer-info-name">{post.user_name || "Guest"}</p>
            <small className="post-main__card-footer-info-date">{new Date(post.date).toLocaleDateString()}</small>
            </div>
